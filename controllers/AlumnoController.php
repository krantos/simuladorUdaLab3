...
class AlumnoController extends Controller
{
    ...
    public function actionDecisiones()
    {
        ...
        return $this->render('decisiones', array('calidades' => $calidades, 'decoracion' => $decoracion, 'horarios' => $horarios, 'lineasprod' => $lineasprod, 'metodospago' => $metodospago, 'publicidad' => $publicidad));
    }
